...
'providers' => [
    ...
    Tec\Assets\Providers\AssetsServiceProvider::class,
];
```
...
'aliases' => [
    ...
    'Assets' => Tec\Assets\Facades\AssetsFacade::class,
];
```
...
```bash
php artisan vendor:publish --provider="Tec\Assets\Providers\AssetsServiceProvider" --tag=config
```
